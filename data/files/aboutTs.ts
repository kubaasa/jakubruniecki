...
export const about = {
  ...
  bio: [
    ...
    "device management. 25+ UAT releases, 2500+ tickets",
    "filed before they ever reached production.",
    "",
    "Last ${automationPhrase} I've been building a Playwright + TypeScript",
    "framework from scratch - POM, auth-state reuse, API mocks,",
    "custom HTML reporting, CI on GitLab.",
    "AI is part of the stack: Claude Code and Playwright MCP/CLI as",
    "senior assistants on demand - the judgement stays mine, and a solo",
    "tester with AI in the loop delivers like a small QA team.",
    "",
